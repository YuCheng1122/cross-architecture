...
for ts in timestamp_dirs:
    ...
    df = pd.DataFrame(rows, columns=[
        "ARM Address", "ARM Function Name", "ARM Set Size",
        "MIPS Address", "MIPS Function Name", "MIPS Set Size",
    ...
    # 修改輸出檔名
    output_csv = os.path.join(COMPARE_DIR, f"Jascard_pcode_similarity_{ts}_arm_vs_mips_{current_time}.csv")
