...
public class ExtractPcodeForComparison extends GhidraScript {
    ...
    /**
     * 以 functionName 的 hash 值作為 label（取絕對值）
     */
    private int getDeterministicLabel(String functionName) {
        return Math.abs(functionName.hashCode());
    }
    ...
    public void run() throws Exception {
        ...
        while (functions.hasNext() && !monitor.isCancelled()) {
            ...
            int label = getDeterministicLabel(functionName);
